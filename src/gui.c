  ...
  for (;;) {
    ...
    for ( int i = 0; i < 13; ++i ) {
      ...
      if ( i == fft_idx ) {
        ...
        display_write_string_with_bg( 0, VDI_LINES_HEIGHT*2, 160, 30, g_str, &font_25_30_font, DISPLAY_COLOR_GREEN, DISPLAY_COLOR_DARKGREEN );
      }
      printf(
    ...
    // значение "сила отклика"
    sprintf( g_str, "%u", v_a );
    display_write_string_with_bg( 160, VDI_LINES_HEIGHT*2, 160, 30, g_str, &font_25_30_font, DISPLAY_COLOR_RED, DISPLAY_COLOR_DARKRED );
    /*
